...
//Map for Повара и их специализации:
let cooks = new Map();
...
//заказ первого клиента Алексей заказал: Пиццу "Пепперони" и Тирамису.
let client1 = { name: 'Алексей'};
let clientOrder1 = new Set();
clientOrder1.add("Пицца 'Пепперони'")
            .add("Тирамису");

//заказ второго клиента Мария заказала: Суши "Калифорния" и Пиццу "Маргарита"
let client2 = { name: 'Мария'};
let clientOrder2 = new Set();
clientOrder2.add("Суши 'Калифорния'")
            .add("Пицца 'Маргарита'");

//заказ третьего клиента Ирина заказала: Чизкейк.
